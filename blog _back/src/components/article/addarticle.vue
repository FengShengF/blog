  ...
  <div class="article">
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
      ...
      <el-form-item label="时间" prop="times">
        <el-time-picker v-model="ruleForm.time" type="datetime" placeholder="选择时间" format="yyyy-MM-dd HH:mm:ss" value-format="yyyy-MM-dd HH:mm:ss">
        </el-time-picker>
      </el-form-item>
...
export default {
  ...
  created() {
    this.axios.get('/api/ariticle/Class').then((data) => {
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        ...
        if (valid && this.editer.getContent() != '') {
          ...
          this.axios.post('/api/article/insert', this.ruleForm).then((data) => {
